...
In [microbenchmarks](https://github.com/golang/go/issues/54766#issuecomment-2542444404), map operations are up to 60% faster than in Go 1.23.
...
For example, we may be able to [increase the locality of](https://github.com/golang/go/issues/70835) operations on maps that are not in the CPU cache.
